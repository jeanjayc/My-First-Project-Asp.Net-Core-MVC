...
namespace SalesWebMvc.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Departments departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Departments departament)
        {
